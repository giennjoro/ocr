...
<div class="">
    <div class="page-title">
        <div class="title_left">
            <h2><i class="fa fa-user"></i>{!! $transaction->completed == true? '<small style="color: green">Successful<i class="fa fa-check text-success"></i></small>': '<small style="color: red"><i class="fa fa-times text-danger"></i>Failed</small>' !!}</h2>
        </div>
                ...
                <div class="x_content">
                    ...
                    <ul class="list-group list-group-unbordered">
                        <li class="list-group-item" style="overflow:auto">
                            <b>Transaction Date</b> <a class="pull-right">{{ $transaction->created_at }}</a>
                        </li>
                        <li class="list-group-item" style="overflow:auto">
                            <b>User's Name</b> 
