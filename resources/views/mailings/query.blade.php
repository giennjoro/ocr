...
<tbody><tr>
  <td>
    ...
    <table bgcolor="#ffffff" class="content" align="center" cellpadding="0" cellspacing="0" border="0">
            ...
            <h1 style="color:tomato; text-align:center;">Double Quick Contact Form</h1>
					</p>
							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateContainer">
									<tbody><tr>
											<td valign="top" class="bodyContent" mc:edit="body_content">
												<p>Hello there Double Quick Admin,</p>
												<p>This is to notify you that you have received a contact message from <a href="https://www.doublequik.com">Double Quick Website</a></p>
                          <br><br>
                          Message From:     <strong>{{$email}}</strong><br><br>
                          Name:             <strong>{{$name}}</strong><br><br>
                          Phone:            <strong>{{$phone}}</strong><br><br>
                          Message Subject:  <strong>{{$subject}}</strong><br><br>


                        <strong></h3>Message</h3></strong><hr>
                        <p>{{ $user_message }}</p>
											</td>
									</tr>
						...
						<tbody><tr>
							<td valign="top" width="100%" mc:edit="footer_unsubscribe">
								<p style="text-align:center;">
									<img src="{{ asset('logo.gif') }}" style="max-width:600px;margin:0 auto 0 auto;display:inline-block;">
								</p>
								<h6 style="text-align:center;margin-top: 9px;">Double Quick</h6>
